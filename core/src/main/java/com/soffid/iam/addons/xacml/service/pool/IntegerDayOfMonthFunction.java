...
public class IntegerDayOfMonthFunction implements Function {

	@Override
	public URI getIdentifier() {
		return URI.create("urn:com.soffid:xacml:2.0:function:integer-day-of-month");
	}
	...
	public EvaluationResult evaluate(List inputs, EvaluationCtx context) {
        ...
        while (it.hasNext()) {
            ...
            if (value != null) {
            	...
            	return new EvaluationResult(new IntegerAttribute(c.get(Calendar.DAY_OF_MONTH)));
            }
        }
